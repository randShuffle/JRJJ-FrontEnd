import {
  ...
  warn
} from "./chunk-7JM6OHIU.js";
import {
  brushSingle,
  requestAnimationFrame_default
} from "./chunk-K3GZDMMK.js";
import {
  Animator_default,
...
function getListCache(axis, prop) {
  return inner2(axis)[prop] || (inner2(axis)[prop] = []);
}
...
function makeAutoCategoryInterval(axis) {
  var result = inner2(axis).autoInterval;
  return result != null ? result : inner2(axis).autoInterval = axis.calculateCategoryInterval();
}
...
zrender/lib/zrender.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-2RTRPRYE.js.map
